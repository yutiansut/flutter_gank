...
import 'package:flutter_gank/widget/gank_web_view.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
          return GankWebView(widget.gankItem);
        }));
      },
      child: Container(
  ...
  List<Widget> _buildGankListItem(BuildContext context) {
    ...
    if (widget.gankItem.images != null && widget.gankItem.images.isNotEmpty) {
      ...
      contentWidgets.add(GestureDetector(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) {
            return GankPhotoView(widget.gankItem.images, widget.gankItem.desc);
          }));
        },
        child: Container(
