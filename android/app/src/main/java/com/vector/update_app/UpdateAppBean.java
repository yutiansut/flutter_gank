...
public class UpdateAppBean implements Serializable {
    ...
    private String updateFlutterBundle;
    //新版本号
    private String new_version;

    private String flutter_version;
    //新app下载地址
    ...
    public boolean isUpdateFlutterBundle() {
        return !TextUtils.isEmpty(this.updateFlutterBundle) && "Yes".equals(this.update);
    }
    ...
    public UpdateAppBean setFlutter_version(String flutter_version) {
        this.flutter_version = flutter_version;
        return this;
    }

    public String getFlutter_version() {
