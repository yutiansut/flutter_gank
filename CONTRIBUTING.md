...
If you have any comment or advice, please report your [issue](https://github.com/lijinshanmx/flutter_gank/issues),
or make any change as you wish and submit an [PR](https://github.com/lijinshanmx/flutter_gank/pulls).
...
Flutter gank group members will confirm the purpose of the issue, replace more accurate tags for it, identify related milestone, and assign developers working on it.
...
- `support`: the issue asks helps from developers of our group. If you need helps to locate and handle problems or have any idea to improve Flutter gank, mark it as `support`.
...
- `deps: xx`: the issue is related to `dependencies`
...
If you are developer of flutter_gank repo and you are willing to contribute, feel free to create a new branch, finish your modification and submit a PR. lijinshanmx will review your work and merge it to master branch.
...
Then you can create a Pull Request at [flutter_gank](https://github.com/lijinshanmx/flutter_gank/pulls)
...
4. User Tips: Notice for flutter gank users. You can skip this part, if the PR is not about update in API or potential compatibility problem.
...
Document change on flutter_gank/gank#123
...
flutter gank uses semantic versioning in release process based on [semver].
...
- `next` branch is labelled with `next` tag, high-level framework can use `flutter_gank@next` to test the in-progress version.
- The LTS versions of flutter gank determined by Milestone. If a version is listed in Milestone, then it is a LTS version. We will patch it if there is any problem with it.
